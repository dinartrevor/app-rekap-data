...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <meta content="Aplikasi Rekap Data Perkara" name="description">
        <meta content="Aplikasi Rekap Data Perkara" name="keywords">
                                ...
                                <form action="{{route('authenticate')}}" method="post" class="row g-3 needs-validation" novalidate>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="input-group has-validation">
                                            ...
                                            <input type="text" name="username" class="form-control @error('username') is-invalid @enderror" autocomplate="off" id="username" placeholder="Enter your Username">
                                            @error('username')
